module github.com/dineshg13/serializer-app
...
require (
	...
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.53.0-devel
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.53.0-devel
